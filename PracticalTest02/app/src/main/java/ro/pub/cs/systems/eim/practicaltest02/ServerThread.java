...
public class ServerThread extends Thread {
    ...
    public synchronized boolean checkWaitTime(String ip, String timp) {
        String minute = timp.split(":")[1];
        Integer minint = Integer.parseInt(minute);

        Integer found = data.get(ip);
        if (found == null || !found.equals(minint)) {
            data.put(ip, minint);
            return true;
        }
        return false;
